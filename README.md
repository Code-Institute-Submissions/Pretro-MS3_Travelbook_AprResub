...
1. Be able to easy navegate through the site.
2. Easy for me to understand what the site is about.
3. Be able to see different pages of the site .
4. Read and understand the texts.
5. The site must be responsive in several devices
6. See the pictures with a good resolution.
7. Able to manage information in an easy way
